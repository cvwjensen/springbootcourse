...
public class TokenController {
    ...
    public List<Token> list() {
        return tokenService.listUserTokens(SecurityContext.getUser().getUsername());
    }
    ...
    public void create(@RequestBody Map<String, String> body) {
        ...
        tokenService.create(token, targetUrl, protectToken, SecurityContext.getUser().getUsername());
    }
    ...
    public void update(@PathVariable String token, @RequestBody Map<String, String> body) {
        final String targetUrl = body.get("targetUrl");
        final String protectToken = body.get("protectToken");
        tokenService.update(token, targetUrl, protectToken, SecurityContext.getUser().getUsername());
    }
    ...
    public void protect(@PathVariable("token") String theToken, @RequestBody Map<String, String> body) {
        ...
        tokenService.update(theToken, token.getTargetUrl(), protectToken, SecurityContext.getUser().getUsername());
    }
}
